 ...
 *
 *  If `object` is the same as the receiver, then instead use `observeOwnChangesToKeyPath:withBlock:`.
 *
 ...
 *
 *  If `object` is the same as the receiver, then instead use `observeOwnChangesToKeyPaths:withBlock:`.
 *
 *  @param object   The object to observe.
 ...
 *  "observer" object.
 *
 *  Use instead of `-[self observeChangesToKeyPath:withBlock:]` when you want the receiver passed as parameter to the
 ...
 *  "observer" object.
 *
 *  Use instead of `-[self observeChangesToKeyPaths:withBlock:]` when you want the receiver passed as parameter to the
 *  block, or when you want to make extra clear that the object is intentionally observing itself.
 *
 *  @param keyPaths Array of key path strings to observe on `object`.
 *  @param block    The block to call when any of the key path observations are triggered, is passed the receiver
